...
def parse_bible_reference(passage):
    ...
    book_numbers = {
        ...
        "1chron": ("13", "1 Chronicles"),
        "1chr": ("13", "1 Chronicles"),
        "1ch": ("13", "1 Chronicles"),
        "1 chr": ("13", "1 Chronicles"),
        "2 chronicles": ("14", "2 Chronicles"),
        "2chron": ("14", "2 Chronicles"),
        "2chr": ("14", "2 Chronicles"),
        "2ch": ("14", "2 Chronicles"),
        "2 chr": ("14", "2 Chronicles"),
        "ezra": ("15", "Ezra"),
        "ezr": ("15", "Ezra"),
        ...
        "ecc": ("21", "Ecclesiastes"),
        "ec": ("21", "Ecclesiastes"),
        "song of songs": ("22", "Song of Songs"),
        "song": ("22", "Song of Songs"),
        "sos": ("22", "Song of Songs"),
        "so": ("22", "Song of Songs"),
        "canticles": ("22", "Song of Songs"),
        "cant": ("22", "Song of Songs"),
        "isaiah": ("23", "Isaiah"),
        "isa": ("23", "Isaiah"),
        "is": ("23", "Isaiah"),
        ...
        "1cor": ("46", "1 Corinthians"),
        "1co": ("46", "1 Corinthians"),
        "1c": ("46", "1 Corinthians"),
        "1 cor": ("46", "1 Corinthians"),
        "2 corinthians": ("47", "2 Corinthians"),
        "2cor": ("47", "2 Corinthians"),
        "2co": ("47", "2 Corinthians"),
        "2c": ("47", "2 Corinthians"),
        "2 cor": ("47", "2 Corinthians"),
        ...
        "1thess": ("52", "1 Thessalonians"),
        "1th": ("52", "1 Thessalonians"),
        "1 thess": ("52", "1 Thessalonians"),
        "1 th": ("52", "1 Thessalonians"),
        "2 thessalonians": ("53", "2 Thessalonians"),
        "2thess": ("53", "2 Thessalonians"),
        "2th": ("53", "2 Thessalonians"),
        "2 thess": ("53", "2 Thessalonians"),
        "2 th": ("53", "2 Thessalonians"),
