...
**📌 IMPORTANT: Check this file FIRST** before asking user about project conventions,
data locations, or pipeline patterns that might already be documented.

---

## Core Files Created by `sp init`

### This File
- **index.md** (this file) - Master index of available AI context
...
**1. Check `project/TODO.md`**
   - Active work, in-progress items, blocked issues
   - What NOT to touch
   - Links to GitHub issues

**2. Check `docs/ai-context/index.md`**
   - **Master index of all AI context available**
   - Lists what documentation exists (pipeline patterns, data sources, conventions)
   - **BEFORE asking user about project conventions or data locations, check if it's documented here**

This index tells you what context files exist. If you need BaseX examples, naming conventions,
or common pipeline patterns, check the index first to see if they're documented.
...
def install_global_conventions(sp_home: Path = None, force: bool = False) -> None:
...
def install_global_skills(sp_home: Path = None, force: bool = False) -> None:
