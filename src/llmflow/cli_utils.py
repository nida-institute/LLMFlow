...
COPILOT_INSTRUCTIONS_DOC = """<!-- Generated by llmflow init -->
...
- Lint first: `llmflow lint --pipeline pipelines/<name>.yaml`
- Dry run: `llmflow run --pipeline pipelines/<name>.yaml --dry-run`
...
VSCODE_DOC = """<!-- Generated by llmflow init -->
...
- [ ] Build Mac + Windows installers via GitHub Actions CI (the blocker)
- [ ] Replace hello-world example with a domain-relevant pipeline (e.g. translation notes, back-translation check)
...
PROJECT_AUDITS_README = """<!-- Generated by llmflow init -->
# Audits
