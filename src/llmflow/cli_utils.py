...
**This file is yours.** `sp init` created it once and will **never overwrite it** — not even
on `sp init --update`. Put this repository's own AI context here: domain facts, local
conventions, data sources, and gotchas specific to *this* repo.

The other files in `docs/ai-context/` (`index.md`, `overview.md`, `rules.md`,
`github-workflow.md`) are generated by `sp init` and refreshed by `sp init --update` — do not
hand-edit them. Anything you want to keep and evolve locally goes here, and `index.md` points
AI assistants at this file.

---

<!-- Add your project's AI context below. -->
"""
