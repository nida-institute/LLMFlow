...
class TestParseBibleReference:
    ...
    def test_filename_prefix_length_verification(self):
        ...
        for passage, expected_length in test_cases:
            ...
            assert actual_length == expected_length, f"Expected {expected_length}, got {actual_length} for '{passage}'"
        ...
        for canonical_name, *variants in variations:
            ...
            for variant in variants:
                try:
                    ...
                    assert variant_result['book_number'] == canonical_result['book_number']
                except ValueError:
    ...
    def test_filename_prefix_format_consistency(self):
        ...
        for passage in test_cases:
            ...
            import re
            pattern = r'^\d{8}-\d{8}$'
            assert re.match(pattern, filename), f"Filename '{filename}' doesn't match expected format for '{passage}'"
    ...
    def test_performance_with_long_inputs(self):
        ...
        assert end_time - start_time < 1.0, "Performance test failed - parsing took too long"
    ...
    def test_unicode_and_special_characters(self):
        ...
        try:
            ...
            result1 = parse_bible_reference("Genesis 1:1")
            result2 = parse_bible_reference("Genesis\u00A01:1")  # Non-breaking space
